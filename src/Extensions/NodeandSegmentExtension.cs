...
namespace CSM.Extensions
{
	...
	public class NodeandSegmentExtension : ThreadingExtensionBase
	{
		...
		bool TreadRunning = false;
		bool UpdateNetNode = false;
		bool UpdateNetSegment = false;
		...
		Vector3 NonVector = new Vector3(0.0f, 0.0f, 0.0f); //a non vector used to distingish between initialised and non initialised Nodes
		public static NetSegment[] _netSegment = Singleton<NetManager>.instance.m_segments.m_buffer;
		NetSegment[] _lastNetSegment = new NetSegment[Singleton<NetManager>.instance.m_segments.m_buffer.Length];
		NetNode[] _netNode = Singleton<NetManager>.instance.m_nodes.m_buffer;
		NetNode[] _lastNetNode = new NetNode[Singleton<NetManager>.instance.m_nodes.m_buffer.Length];
