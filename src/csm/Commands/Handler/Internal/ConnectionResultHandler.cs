...
namespace CSM.Commands.Handler.Internal
{
    public class ConnectionResultHandler : CommandHandler<ConnectionResultCommand>
    {
        ...
        protected override void Handle(ConnectionResultCommand command)
        {
            ...
            if (MultiplayerManager.Instance.CurrentClient.Status != global::CSM.API.Networking.Status.ClientStatus.Connecting)
                return;
            ...
            if (command.Success)
            {
                ...
                MultiplayerManager.Instance.CurrentClient.ClientPlayer = new global::CSM.Networking.Player();
                MultiplayerManager.Instance.CurrentClient.Status = global::CSM.API.Networking.Status.ClientStatus.Downloading;
